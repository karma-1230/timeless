    ...
    return (
        <div className="dark-signup-container d-flex align-items-center justify-content-center">
            <div className="dark-signup-box rounded shadow-lg p-5">
                ...
                {/* Form Title */}
                <h3 className="fw-bold text-light mb-2">Create new account.</h3>
                <p className="text-muted mb-4">
                    Already a member? <a href="#" className="text-decoration-none text-primary">Log in</a>
                </p>
                ...
                <form>
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            <input type="text" className="form-control dark-input" placeholder="First name" />
                        </div>
                        <div className="col-md-6 mb-3">
                            <input type="text" className="form-control dark-input" placeholder="Last name" />
                        </div>
                    </div>
                    <div className="mb-3">
                        <input type="text" className="form-control dark-input" placeholder="Addresss" />
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="d-flex gap-3">
                        ...
                        <button type="submit" className="btn btn-primary flex-fill">Create account</button>
                    </div>
                </form>
            </div>
        </div>
