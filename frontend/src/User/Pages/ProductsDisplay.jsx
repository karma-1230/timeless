...
import { getProducts, addToCart } from "../../api"; // Your API functions
...
function ProductsDisplay() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const res = await getProducts(); // API call to fetch DB products
    ...
    if (products.length === 0) return <p style={{ textAlign: "center", marginTop: "100px" }}>No products available.</p>;
